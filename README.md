...
Calculate Scope 2 emissions using both accepted accounting methods.
...
The reporting period is the calendar year 2025.
...
Scope 2 covers purchased electricity and purchased steam.

The workbook reports Scope 2 emissions using:
...
The workbook also calculates the absolute and percentage difference between the two Scope 2 results.
...
Category 8 is treated as not applicable because the relevant leased assets are assumed to be inside the operational boundary and already covered under Scope 1 and Scope 2.
...
SUM for emissions totals
SUMIF for category-level aggregation
IF for inclusion and exclusion logic
INDEX and MATCH for identifying the largest category
...
Spend-based and downstream factors are simplified proxies.
